...
SECRET_KEY = "@fkn56j52)#i5p0*-y=hrh$u-iek(61d2em2l9)1bl*cxe60qv"
...
CELERY_BROKER_URL = os.environ.get("HEROKU_REDIS_ORANGE_URL")
CELERY_RESULT_BACKEND = os.environ.get("HEROKU_REDIS_ORANGE_URL")
